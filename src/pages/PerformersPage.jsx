...
import { Link, useParams, useNavigate } from 'react-router-dom';  // 必要なフックをインポート
import { User, Plus, Search, Eye, Download, Trash } from 'lucide-react';  // 必要なアイコンをインポート
import { getPerformers } from '../services/performerService';  // 正しい関数をインポート
